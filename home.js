            ...
            let content = `
                ...
                <div class="card shadow my-3">
                    ...
                    <div class="card-header">
                        ...
                        <div id="userInfo-div" onclick="getUserInfo(${post.author.id})">
...
function getUserInfo(profileId) {
    ...
    window.location = `profile.html?profileId=${profileId}`
}

function addPostClicked() {
    
    postSubmitButtonElement.innerHTML = "Create Post"
    postIdElement.value = ""
    postModalTitleElement.innerHTML = "Create A New Post"
    createPostTitleElement.value = ""
    createPostBodyElement.value = ""
